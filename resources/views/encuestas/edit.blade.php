    ...
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Editar encuestas</li>
            </ol>
   ...
   {{--  @csrf  --}}
    ...
    <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
            ...
            {!! Form::radio('tipo_encuesta_id',$item->id,$encuesta->tipo_encuesta ==$item ? true:false)!!}
    ...
    <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
           ...
           {!! Form::checkbox('status', 1, $encuesta->status ==1 ?true : false, null) !!}
